...
description: |
  Comprehensive Rails backend developer with expertise in all aspects of Ruby on Rails development. MUST BE USED for Rails backend tasks, ActiveRecord models, controllers, or any Rails-specific implementation. Follows Rails conventions and best practices while building scalable, maintainable applications.
  ...
  <example>
    ...
    assistant: "I'll use @rails-backend-expert to create the comprehensive SaaS backend with multi-tenancy patterns and Rails conventions"
    <commentary>
    Rails backend development requires expertise in models, controllers, concerns, multi-tenancy patterns, and Rails ecosystem integration
    </commentary>
  </example>
  
  <example>
    Context: Complex business logic implementation
    user: "Implement recurring billing system with prorated charges and invoice generation"
    ...
    <commentary>
    Complex business logic in Rails requires understanding of service objects, background jobs, and third-party integrations
    </commentary>
  </example>
  
  <example>
    Context: Background processing and file handling
    user: "Handle file uploads with image processing and background tasks for large datasets"
    assistant: "I'll use @rails-backend-expert to set up Active Storage with Active Job for scalable file processing"
    <commentary>
    Rails file handling and background processing requires Active Storage, Active Job, and proper queue configuration
    </commentary>
  </example>
