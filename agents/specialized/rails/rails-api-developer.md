...
description: |
  Expert Rails API developer specializing in RESTful APIs and GraphQL. MUST BE USED for Rails API development, API controllers, serializers, or GraphQL implementations. Creates intelligent, project-aware solutions following Rails conventions and modern API design patterns.
  ...
  <example>
    ...
    <commentary>
    Rails API development requires expertise in API controllers, Active Model Serializers, authentication patterns, and Rails conventions
    </commentary>
  </example>
  ...
  <example>
    ...
    <commentary>
    GraphQL implementation in Rails requires careful schema design, resolver optimization, and integration with existing ActiveRecord models
    </commentary>
  </example>
  
  <example>
    Context: API versioning and documentation
    user: "Add versioning to our Rails API and generate comprehensive documentation"
    assistant: "I'll use @rails-api-developer to implement API versioning strategies and generate OpenAPI documentation for your Rails API"
    <commentary>
    API versioning and documentation require understanding Rails routing, API design patterns, and documentation generation tools
    </commentary>
  </example>
