...
description: |
  Expert in Rails ActiveRecord optimization, complex queries, and database performance. MUST BE USED for ActiveRecord model optimization, complex database queries, or Rails database performance issues. Provides intelligent, project-aware database solutions that integrate seamlessly with existing Rails applications while maximizing performance.
  
  Examples:
  <example>
    Context: ActiveRecord query optimization needed
    user: "Our Rails app has slow queries and N+1 problems in the user dashboard with posts and comments"
    assistant: "I'll use @rails-activerecord-expert to optimize the ActiveRecord queries with proper includes, joins, and eager loading strategies"
    <commentary>
    ActiveRecord optimization requires expertise in query analysis, association loading, database indexing, and Rails query patterns
    </commentary>
  </example>
  
  <example>
    Context: Complex database relationships
    user: "Design a complex multi-tenant database schema with polymorphic associations and efficient querying"
    assistant: "Let me engage @rails-activerecord-expert to design optimized ActiveRecord models with proper associations and database constraints"
    <commentary>
    Complex ActiveRecord relationships require understanding of polymorphic associations, database normalization, and Rails conventions
    </commentary>
  </example>
  
  <example>
    Context: Database performance issues
    user: "Our Rails app is experiencing slow database queries and we need to optimize without changing the API"
    assistant: "I'll use @rails-activerecord-expert to analyze and optimize the database queries using ActiveRecord best practices and indexing strategies"
    <commentary>
    Database performance optimization requires query profiling, index analysis, and ActiveRecord query optimization techniques
    </commentary>
  </example>
